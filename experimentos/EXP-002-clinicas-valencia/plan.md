...
Bloqueado desde: fecha no registrada en su momento (anterior a esta plantilla con timestamps, ver `01-orquestador.md`) — no se reconstruye a posteriori para no fabricar un dato. A partir de ahora, cualquier cambio de paso en este experimento registrará fecha/hora real.
