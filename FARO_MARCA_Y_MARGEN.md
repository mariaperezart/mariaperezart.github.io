...
4. **La marca debe atraer al cliente correcto, no al más numeroso.** Más alcance no siempre implica mejores resultados; la calidad de la audiencia importa más que su tamaño — refuerza por qué `FARO_MODELO_NEGOCIO.md` 3.1 define un ICP estrecho a propósito en vez de perseguir cualquier clínica.
