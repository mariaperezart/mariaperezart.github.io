...
**Nota de pivote (ver `FARO_MODELO_NEGOCIO.md`, sección 1.1)**: este catálogo se construyó investigando específicamente el vertical dental, dentro de la tesis de validación original. El ICP de FARO se ha ampliado desde entonces a pyme de servicios con agenda en la provincia de León (dental, veterinaria, fisioterapia/estética, peluquería, talleres, academias). Las 14 categorías de proceso (Captación, Ventas, Recepción, Agenda, Recordatorios, Presupuestos, Seguimiento, Reseñas, Pacientes/clientes inactivos, Marketing, Administración, RR.HH., Finanzas, Análisis) son agnósticas de vertical y se conservan como marco de priorización — cualquier pyme con agenda tiene estos mismos 14 frentes operativos. Las 100 automatizaciones concretas, tal como están redactadas, usan vocabulario y casos de uso específicamente dentales (ortodoncia, odontopediatría, historia clínica, gabinete) y **no se reescriben mecánicamente aquí**: antes de usar este catálogo con un cliente de otro vertical, cada fila relevante debe adaptarse a su vocabulario y su proceso real, siguiendo la misma lógica pero sin asumir automáticamente que "paciente" es intercambiable por "cliente" en cada caso concreto (algunas automatizaciones, como la de odontopediatría o historia clínica, no tienen equivalente directo fuera de un vertical sanitario). Este trabajo de adaptación por vertical queda pendiente como parte del roadmap de validación de los primeros clientes no dentales.
