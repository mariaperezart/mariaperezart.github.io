...
`FARO_MODELO_NEGOCIO.md` 3.2 define un buyer persona único ("el dueño que hace de todo") y la sección 3.2-bis ya empieza a segmentarlo en 4 perfiles de hipótesis (empresario tradicional, en crecimiento, empresa familiar, negocio joven), organizados por madurez del negocio. Ese es un eje distinto y complementario al que propone este documento: tratar el perfil de riesgo del comprador (conservador ↔ orientado a crecimiento) como una segunda dimensión, no sustituta — dentro del mismo ICP (pyme leonesa con agenda), habrá dueños más conservadores (necesitan piloto, garantías, referencias) y dueños más orientados a crecimiento (les importa más el ROI y la velocidad que la garantía), y esa variable puede cruzarse con cualquiera de los 4 perfiles de madurez de 3.2-bis en vez de sustituirlos.
...
- Cuando el Tracker (`.claude/agents/07-tracker.md`) registre una objeción, añadir opcionalmente una nota de una frase sobre la señal de perfil que la acompañó (ej. "pidió garantías y preguntó por el coste antes que por el ROI" → conservador; "preguntó directamente por escalar a más de un negocio" → orientado a crecimiento). No como categoría cerrada nueva — como texto libre que el Agente de Aprendizaje revise al cerrar el experimento.
...
2. **"El acceso al crédito explica el comportamiento."** Puede influir, pero también la cultura empresarial, el momento económico del negocio y la experiencia previa con proveedores tecnológicos que prometieron de más — `FARO_ESTRATEGIA_MARCA.md` ya identifica esto último como una objeción de fondo frecuente en el sector.
