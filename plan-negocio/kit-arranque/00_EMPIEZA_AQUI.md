...
3. **Busca LUMBRE en la OEPM, clases 35 y 42.** Gratis, 15 minutos, y es lo único que puede reabrir la decisión del nombre. Si sale limpia, compra `lumbreestudio.es` (12 €) y sigue. Ver `16_MARCA_LUMBRE.md`.
3.a **Quita el ® de la web publicada, hoy.** Si la marca no está registrada, ese símbolo no se puede usar.
